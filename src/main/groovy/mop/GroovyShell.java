...
public class GroovyShell {
    ...
    private Object runScriptOrMainOrTestOrRunnable(Class scriptClass, String[] args) {
        ...
        if (Script.class.isAssignableFrom(scriptClass)) {
            ...
            if (script != null) {
                ...
                GroovyInvoker.setProperty(script,"args", args);
                return script.run();
            }
        }
        try {
            ...
            return GroovyInvoker.invoke(scriptClass, "main", (Object[]) args);
    ...
    private Object runJUnit3Test(Class scriptClass) {
        try {
            Class suite = Class.forName("junit.framework.TestSuite",true, this.getClass().getClassLoader());
            Object testSuite = GroovyInvoker.newInstance(suite);
            Class runner = Class.forName("junit.textui.TestRunner", true, this.getClass().getClassLoader());
            return GroovyInvoker.invoke(runner, "run", testSuite);
    ...
    private Object runJUnit3TestSuite(Class scriptClass) {
        try {
            Object testSuite = GroovyInvoker.invoke(scriptClass, "suite");
            Class runner = Class.forName("junit.textui.TestRunner", true, this.getClass().getClassLoader());
            return GroovyInvoker.invoke(runner, "run", testSuite);
        } catch (ClassNotFoundException e) {
            throw new GroovyRuntimeException("Failed to run the unit test. JUnit is not on the Classpath.", e);
    ...
    private Object runJUnit4Test(Class scriptClass) {
        try {
            Class utils = Class.forName("org.codehaus.groovy.vmplugin.v5.JUnit4Utils");
            return GroovyInvoker.invoke(utils, "realRunJUnit4Test", scriptClass, this.loader);
        } catch (ClassNotFoundException e) {
    ...
    private boolean isJUnit4Test(Class scriptClass) {
        ...
        try {
            Class utils = Class.forName("org.codehaus.groovy.vmplugin.v5.JUnit4Utils");
            isTest = GroovyInvoker.invoke(utils,"realIsJUnit4Test", scriptClass, this.loader);
        } catch (ClassNotFoundException e) {
    ...
    public Script parse(final GroovyCodeSource codeSource) throws CompilationFailedException {
        return GroovyInvoker.createScript(parseClass(codeSource), context);
    }
